...
growth_time: 14, garden_id: spring_g1.id) 
...
growth_time: 10, garden_id: spring_g1.id)
...
growth_time: 11, garden_id: spring_g1.id)
...
growth_time: 8, garden_id: spring_g1.id)
...
growth_time: 17, garden_id: summer_g1.id)
...
growth_time: 12, garden_id: summer_g1.id)
...
growth_time: 13, garden_id: summer_g1.id)
...
growth_time: 9, garden_id: summer_g1.id)
...
growth_time: 14, garden_id: summer_g1.id)
...
growth_time: 4, garden_id: fall_g1.id)
...
growth_time: 21, garden_id: fall_g1.id)
...
growth_time: 6, garden_id: fall_g1.id)
...
growth_time: 5 , garden_id: fall_g1.id)
...
growth_time: 14, garden_id: fall_g1.id)
